...
async function generateProgramAI(data, calculatedBodyFat) {
    ...
    9. סינון איכות חלבון (High-Quality Protein Only): התעלם לחלוטין משאריות חלבון (Trace Protein). מאכלים כמו חמאת בוטנים, טחינה, אגוזים, זרעים, שיבולת שועל, לחם וקטניות רגילות לא יתרמו שום ערך לבנק החלבון. חלבון ייספר אך ורק ממקורות של חלבון מלא: מהחי (עוף, בקר, דגים, ביצים, חלב), אבקות חלבון, או חלבוני סויה מלאים (אדממה, טופו).
