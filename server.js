...
async function generateProgramAI(data, calculatedBodyFat) {
    ...
    6. קיבוע עוגני פירות בשרת (Hardcoded Fruit Categories): באובייקט ה-portion_bank תחת קטגוריית הפחמימות, חובה עליך לחשב את משקל מנה אחת של פרי (אשר שווה למנת פחמימה של 80 קלוריות ו-15 גרם פחמימה) אך ורק לפי שלוש קבוצות הצפיפות הבאות:
       - קבוצה א' (צפיפות גבוהה: כ-20g פחמימה ל-100g): בננה, תמרים, פירות יבשים, ענבים. מנת פחמימה מקבוצה זו תוגדר תמיד כ-70-80 גרם של פרי.
       - קבוצה ב' (צפיפות בינונית: כ-10g-15g פחמימה ל-100g): תפוח, אגס, אפרסק, מנגו, תפוז, קלמנטינה, שזיף, ואוכמניות (Blueberries). מנת פחמימה מקבוצה זו תוגדר תמיד כ-100-150 גרם של פרי (או פרי בינוני אחד). במקרה הספציפי של אוכמניות, המשקל יוגדר בדיוק כ-100 גרם למנה.
       - קבוצה ג' (צפיפות נמוכה/מים: כ-6g-8g פחמימה ל-100g): תותים, אבטיח, מלון, פטל (Raspberries). מנת פחמימה מקבוצה זו תוגדר תמיד כ-200-250 גרם של פרי.
    7. אכיפת הרינדור בבנק התחליפים: חובה עליך לשלב נציגים מכל שלוש קבוצות הפירות הנ"ל בתוך בנק הפחמימות המוצג למשתמש. חובה לציין במדויק את המשקל בגרמים לכל פרי כפי שהוגדר לעיל, כדי שהמשתמש יבין את ההבדל הכמותי.
